...
export default function App() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#050508] text-white flex flex-col items-center justify-center p-4 font-sans overflow-hidden">
      <div className={`relative w-full max-w-[600px] aspect-[600/800] bg-black rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(59,130,246,0.2)] border border-white/10 ${isFullscreen ? 'h-full max-h-screen rounded-none border-none aspect-auto' : ''}`}>
